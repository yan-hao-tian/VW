_base_ = [
    './unireplknet_vw.py', '../_base_/datasets/ade20k_640x640.py',
...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(type='Pretrained', checkpoint='unireplknet_l_in22k_to_in1k_384_acc87.88.pth')
    ),
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='ResizeToMultiple', size_divisor=64),
