...
class MSDeformAttnTransformerEncoderLayer(nn.Module):
    ...
    def forward(self, src, pos, reference_points, spatial_shapes, level_start_index, padding_mask=None):
        ...
        # src2 = self.self_attn(query=self.with_pos_embed(src, pos), value=src, reference_points=reference_points, spatial_shapes=spatial_shapes, level_start_index=level_start_index, key_padding_mask=padding_mask)
